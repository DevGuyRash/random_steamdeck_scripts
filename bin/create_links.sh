...
if [[ ! -L "$shortcuts_directory/compatdata" ]]; then
...
for file in ${app_mani_dir}; do
  ...
  if [[ -d "$app_dir" ]]; then
    ...
    echo "App Name: $app_name | App ID: $app_id | $compat_dir/$app_id" >>"$shortcuts_directory/app_ids.txt"
